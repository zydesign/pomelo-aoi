 ...
 *  指定的灯塔的范围（{0,0}-{this.max.x，this.max.x}），就是指定那几个灯塔
...
pro.getIdsByRange = function(pos, range, types){
  ...
  var result = {};
  var p = this.transPos(pos); //通过对象坐标算出的灯塔列阵位置
